  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo web_root; ?>" class="logo">
        ...
        <span class="logo-mini stretch-img"><b><img src="<?php echo web_root; ?>/dist/img/logo02.svg"></b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Pearl Dental Clinic</b></span>
        ...
        <ul class="sidebar-menu">
          ...
          <?php if ($_SESSION['ADMIN_ROLE'] == "Administrator") { ?>
            ...
            <li class="treeview <?php echo (currentpage() == 'user' || currentpage() == 'suplier' ||
                                  ...
                                  currentpage() == 'SetupPrescriptionPrint' || currentpage() == 'settings' ||  currentpage() == 'taxsettings' || currentpage() == 'autonumber') ? "active" : false; ?>">
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?php echo (currentpage() == 'SetupPrescriptionPrint') ? "active" : false; ?>"><a href="<?php echo web_root; ?>SetupPrescriptionPrint/"><i class="fa fa-circle-o"></i> Setup Prescription Print</a></li>
                <li class="<?php echo (currentpage() == 'settings') ? "active" : false; ?>"><a href="<?php echo web_root; ?>settings/"><i class="fa fa-circle-o"></i> Setup Invoices Print</a></li>
              ...
              <div class="box-body">
                <div id="check_msg">
                  ...
                  <?php if ($title != 'Dashboard') {
                    htmlspecialchars(check_message());
                  }
                  ?>
                </div>
                <?php
    ...
    <footer class="main-footer no-print">
      <div class="pull-right hidden-xs">
        <!-- <b>Version</b> Version 2.3.2 -->
      </div>
      <strong>Copyright &copy; 2025 <a href="#">TeamGroup</a>.</strong> All rights
      reserved.
    </footer>
...
<script>
  ...
  setTimeout(function() {
    window.location = "<?php echo web_root; ?>logout.php";
  }, 1800000);
