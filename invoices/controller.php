...
function doUpdateStatus()
{
    ...
    $sql = "UPDATE tblpayments SET Status='Paid', PaymentDate='{$today_datetime}'  WHERE InvoiceNo = '{$invno}'";
    $mydb->setQuery($sql);
    $mydb->executeQuery();
...
//     // H:i:s لضمان حفظ الساعة والدقيقة والثانية
//     $today_datetime = date('Y-m-d H:i:s'); 
    
//     // **2. تعديل جملة SQL لتحديث الحالة (Status) وتاريخ الدفع (PaymentDate):**
//     $sql = "UPDATE tblpayments 
//             SET Status='Paid', 
//                 PaymentDate='{$today_datetime}' 
