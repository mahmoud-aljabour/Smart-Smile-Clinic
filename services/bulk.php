...
<div class="bulkform">
	<form class="form-horizontal span6 " id="bulk_form" action="controller.php?action=addbulk" method="POST" autocomplete="off">
		...
		<div class="form-group">
			<div class="col-md-8">
				...
				<div class="col-md-8">
					...
					<input class="form-control input-sm" id="QTY" name="QTY" placeholder="Quantity" type="number">
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="col-md-8">
				<label class="col-md-4 control-label" for="Price">Bulk Price:</label>
				<div class="col-md-8">
					<input class="form-control input-sm" id="Price" name="Price" placeholder="Price">
				</div>
			</div>
		</div>
