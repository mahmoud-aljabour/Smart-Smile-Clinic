...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">Add Quantity</h1>
  </div>
  <!-- /.col-lg-12 -->
</div>
<form class="form-horizontal span6" action="controller.php?action=qty" Method="POST">
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="Stocks">QTY:</label>

      <input type="hidden" name="ProductID" value="<?php echo $res->ProductID; ?>">
      <div class="col-md-8">
        <input class="form-control input-sm" id="Stocks" name="Stocks" placeholder="Quantity" type="text" value="" autocomplete="off">
      </div>
    </div>
  </div>
