...
<div class="page-header-bar">
  <div>
    <h1 class="h3 mb-1">Edit Service</h1>
...
<form action="controller.php?action=edit" method="POST" enctype="multipart/form-data" autocomplete="off" id="serviceForm" class="form-add-page" novalidate>
      ...
      <div class="row g-3">
        <div class="col-md-4">
          ...
          <div class="input-group">
            ...
            <input class="form-control" id="SKU" name="SKU" type="text" value="<?php echo htmlspecialchars($service->SKU); ?>" readonly>
          </div>
        </div>
        <div class="col-md-8">
          <label class="form-label" for="Services">Service Name <span class="required">*</span></label>
          <input class="form-control" id="Services" name="Services" placeholder="e.g. Root Canal Treatment" type="text" value="<?php echo htmlspecialchars($service->Services); ?>" required>
          <div class="invalid-feedback">Service name is required.</div>
        </div>
        <div class="col-md-12">
          <label class="form-label" for="Description">Description</label>
          <textarea class="form-control" id="Description" name="Description" placeholder="Brief description of the service (optional)" rows="2"><?php echo htmlspecialchars($service->Description); ?></textarea>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="card-body">
      <div class="row g-3">
        <div class="col-md-6">
          ...
          <select class="form-select" id="AgeGroupID" name="AgeGroupID" required>
            ...
            <?php foreach ($age_groups as $group): ?>
              <option value="<?php echo (int)$group->AgeGroupID; ?>" data-toothcount="<?php echo (int)$group->ToothCount; ?>" <?php echo ((int)$service->AgeGroupID === (int)$group->AgeGroupID) ? 'selected' : ''; ?>>
        ...
        <div class="col-md-6">
          ...
          <input class="form-control" id="ToothNumber" name="ToothNumber" placeholder="e.g. 0 (all), 1, 2-5" type="text" value="<?php echo htmlspecialchars($service->ToothNumber); ?>" required>
      ...
      <div class="row g-3">
        <div class="col-md-4">
          ...
          <div class="input-group">
            ...
            <input class="form-control" id="OriginalPrice" name="OriginalPrice" placeholder="0.00" type="number" step="0.01" min="0.01" value="<?php echo htmlspecialchars($service->OriginalPrice); ?>" required>
          </div>
