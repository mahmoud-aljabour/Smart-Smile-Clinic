        ...
        <table id="dash-tables" class="table table-striped table-bordered table-hover" style="font-size:12px" cellspacing="0">
            ...
            <tbody>
                ...
                foreach ($cur as $result) {
                    ...
                    if ($payment_date == '0000-00-00 00:00:00' || empty($payment_date) || is_null($payment_date)) {
                        $display_date = '<span class="badge bg-danger">Not Paid</span>';
                    } else {
                        $display_date = date('Y-m-d H:i', strtotime($payment_date));
                    }
