...
<form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="CurrencySymbol">Currency:</label>

      <div class="col-md-8">
        <input type="hidden" name="CurrencyID" value="<?php echo $res->CurrencyID; ?>">
        <input class="form-control input-sm" id="CurrencySymbol " name="CurrencySymbol" placeholder="Currency" type="text" value="<?php echo $res->CurrencySymbol; ?>" autocomplete="off">
      </div>
    </div>
  </div>
