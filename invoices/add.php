...
<div id="loading-client" class="col-md-12" style="text-align: center;">
	<p><img src="<?php echo web_root; ?>dist/img/loading2.gif"
	/> Please Wait</p>
</div>
			...
			<div class="col-md-12">
				...
				<div>
					<div class="input-group date" id="datepicker-container">
						<input type="text"
							class="form-control input-sm date_inv"
							id="DateInvoiced"
							name="DateInvoiced"
							value="<?php echo date_format(date_create($res->InvoiceDate), 'm/d/Y'); ?>"
							readonly /> <span class="input-group-addon" style="pointer-events: none;"><i class="fa fa-th"></i></span>
					</div>
				</div>
		...
		<div class="col-md-12" style="margin-top: 9px">
			<div class="col-md-12 table-responsive">
				<div class="autocomplete search">
					...
					<input type="text" name="SKU" id="SKU" class="form-control" placeholder="Input the first letter.." autocomplete="off" required> <a href="#" class="btn btn-md btn-primary" id="addtoinvoice" name="addinvoice">Add to Invoice</a>
