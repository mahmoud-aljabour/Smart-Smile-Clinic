...
<form class="form-horizontal span6" action="controller.php?action=add" method="POST" autocomplete="off">
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input class="form-control input-sm" id="Fname" name="Fname" placeholder="Firts Name" type="text"
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input class="form-control input-sm" id="Mname" name="Mname" placeholder="Middle Name"
    ...
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input class="form-control input-sm" id="Lname" name="Lname"
          placeholder="Last Name" type="text" value="" autocomplete="off">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <textarea class="form-control input-sm" id="F_Address" name="F_Address"
          placeholder="Address 1" type="text" value="" onkeyup="javascript:capitalize(this.id, this.value);"
